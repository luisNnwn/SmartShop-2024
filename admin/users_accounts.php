...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="users_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('¿Desea eliminar esta cuenta? ¡La información relacionada con el usuario también se eliminará!')" class="delete-btn">eliminar</a>
   </div>
   <?php
         }
      }else{
